...
void MIMEType::init(){
  if(!initialized){
    ...
    set("arj", "application/octet-stream");
    set("art", "image/x-jg");
    set("asf", "video/x-ms-asf");
    set("asm", "text/x-asm");
    set("asp", "text/asp");
    set("asx", "application/x-mplayer2");
    set("asx", "video/x-ms-asf");
    set("asx", "video/x-ms-asf-plugin");
    set("au", "audio/basic");
    set("au", "audio/x-au");
    set("avi", "application/x-troff-msvideo");
    set("avi", "video/avi");
    set("avi", "video/msvideo");
    set("avi", "video/x-msvideo");
    set("avs", "video/avs-video");
    set("bcpio", "application/x-bcpio");
    set("bin", "application/mac-binary");
    set("bin", "application/macbinary");
    set("bin", "application/octet-stream");
    set("bin", "application/x-binary");
    set("bin", "application/x-macbinary");
    set("bm", "image/bmp");
    set("bmp", "image/bmp");
    set("bmp", "image/x-windows-bmp");
    ...
    set("class", "application/java-byte-code");
    set("class", "application/x-java-class");
    set("com", "application/octet-stream");
    set("com", "text/plain");
    set("conf", "text/plain");
    set("cpio", "application/x-cpio");
    set("cpp", "text/x-c");
    set("cpt", "application/mac-compactpro");
    set("cpt", "application/x-compactpro");
    set("cpt", "application/x-cpt");
    set("crl", "application/pkcs-crl");
    set("crl", "application/pkix-crl");
    set("crt", "application/pkix-cert");
    set("crt", "application/x-x509-ca-cert");
    set("crt", "application/x-x509-user-cert");
    set("csh", "application/x-csh");
    set("csh", "text/x-script.csh");
    set("css", "application/x-pointplus");
    set("css", "text/css");
    set("cxx", "text/plain");
    ...
    set("gz", "application/x-compressed");
    set("gz", "application/x-gzip");
    set("gzip", "application/x-gzip");
    set("gzip", "multipart/x-gzip");
    set("h", "text/plain");
    set("h", "text/x-h");
    ...
    set("hh", "text/plain");
    set("hh", "text/x-h");
    set("hlb", "text/x-script");
    set("hlp", "application/hlp");
    set("hlp", "application/x-helpfile");
    set("hlp", "application/x-winhelp");
    set("hpg", "application/vnd.hp-hpgl");
    set("hpgl", "application/vnd.hp-hpgl");
    set("hqx", "application/binhex");
    set("hqx", "application/binhex4");
    set("hqx", "application/mac-binhex");
    set("hqx", "application/mac-binhex40");
    set("hqx", "application/x-binhex40");
    set("hqx", "application/x-mac-binhex40");
    ...
    set("lzx", "application/octet-stream");
    set("lzx", "application/x-lzx");
    set("m", "text/plain");
    set("m", "text/x-m");
    set("m1v", "video/mpeg");
    set("m2a", "audio/mpeg");
    ...
    set("mid", "music/crescendo");
    set("mid", "x-music/x-midi");
    set("midi", "application/x-midi");
    set("midi", "audio/midi");
    set("midi", "audio/x-mid");
    set("midi", "audio/x-midi");
    set("midi", "music/crescendo");
    set("midi", "x-music/x-midi");
    set("mif", "application/x-frame");
    ...
    set("mp2", "video/mpeg");
    set("mp2", "video/x-mpeg");
    set("mp2", "video/x-mpeq2a");
    set("mp3", "audio/mpeg3");
    set("mp3", "audio/x-mpeg-3");
    set("mp3", "video/mpeg");
    set("mp3", "video/x-mpeg");
    set("mpa", "audio/mpeg");
    set("mpa", "video/mpeg");
    ...
    set("p7c", "application/x-pkcs7-mime");
    set("p7m", "application/pkcs7-mime");
    set("p7m", "application/x-pkcs7-mime");
    ...
    set("pm", "text/x-script.perl-module");
    set("pm4", "application/x-pagemaker");
    set("pm5", "application/x-pagemaker");
    set("png", "image/png");
    set("pnm", "application/x-portable-anymap");
    ...
    set("ppt", "application/x-mspowerpoint");
    ...
    set("ra", "audio/x-pn-realaudio-plugin");
    set("ra", "audio/x-realaudio");
    set("ram", "audio/x-pn-realaudio");
    set("ras", "application/x-cmu-raster");
    set("ras", "image/cmu-raster");
    ...
    set("rng", "application/vnd.nokia.ringing-tone");
    ...
    set("rt", "text/vnd.rn-realtext");
    set("rtf", "application/rtf");
    set("rtf", "application/x-rtf");
    set("rtf", "text/richtext");
    ...
    set("scm", "text/x-script.guile");
    set("scm", "text/x-script.scheme");
    set("scm", "video/x-scm");
    set("sdml", "text/plain");
    set("sdp", "application/sdp");
    set("sdp", "application/x-sdp");
    set("sdr", "application/sounder");
    set("sea", "application/sea");
    set("sea", "application/x-sea");
    set("set", "application/set");
    set("sgm", "text/sgml");
    set("sgm", "text/x-sgml");
    set("sgml", "text/sgml");
    set("sgml", "text/x-sgml");
    set("sh", "application/x-bsh");
    set("sh", "application/x-sh");
    set("sh", "application/x-shar");
    set("sh", "text/x-script.sh");
    set("shar", "application/x-bsh");
    ...
    set("stl", "application/x-navistyle");
    ...
    set("xla", "application/x-excel");
    set("xla", "application/x-msexcel");
    set("xlb", "application/excel");
    set("xlb", "application/vnd.ms-excel");
    set("xlb", "application/x-excel");
    set("xlc", "application/excel");
    set("xlc", "application/vnd.ms-excel");
    set("xlc", "application/x-excel");
    set("xld", "application/excel");
    set("xld", "application/x-excel");
    set("xlk", "application/excel");
    set("xlk", "application/x-excel");
    set("xll", "application/excel");
    set("xll", "application/vnd.ms-excel");
    set("xll", "application/x-excel");
    set("xlm", "application/excel");
    set("xlm", "application/vnd.ms-excel");
    set("xlm", "application/x-excel");
    set("xls", "application/excel");
    set("xls", "application/vnd.ms-excel");
    set("xls", "application/x-excel");
    set("xls", "application/x-msexcel");
    set("xlt", "application/excel");
    set("xlt", "application/x-excel");
    set("xlv", "application/excel");
    set("xlv", "application/x-excel");
    set("xlw", "application/excel");
    set("xlw", "application/vnd.ms-excel");
    set("xlw", "application/x-excel");
    ...
    set("zip", "application/x-compressed");
    set("zip", "application/x-zip-compressed");
    set("zip", "application/zip");
    set("zip", "multipart/x-zip");
